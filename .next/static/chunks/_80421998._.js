...
function AdminPage() {
    ...
    // OCR 상태
    const [ocrPreviewItems, setOcrPreviewItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [ocrCardType, setOcrCardType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("credit");
    ...
    const [ocrDuplicateItems, setOcrDuplicateItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleCardExcelApply = ()=>{
        ...
        if (marketAmount > 0) messages.push("전통시장 ".concat(marketAmount.toLocaleString("ko-KR"), "원"));
        if (cultureAmount > 0) messages.push("문화체육 ".concat(cultureAmount.toLocaleString("ko-KR"), "원"));
    ...
    const processImageFiles = async (files)=>{
        ...
        for (const file of filesToProcess){
            if (file.type.startsWith("image/")) {
                const base64 = await new Promise((resolve)=>{
                    ...
                    reader.onload = (event)=>{
                        var _event_target;
                        return resolve((_event_target = event.target) === null || _event_target === void 0 ? void 0 : _event_target.result);
                    };
        ...
        showNotification("success", "".concat(newImages.length, "개 이미지 분석 중..."));
        try {
            ...
            if (data.items && Array.isArray(data.items) && data.items.length > 0) {
                ...
                adjustedItems.forEach((item)=>{
                    const key = "".concat(item.merchant, "-").concat(item.amount);
                    if (!seenItems[key]) {
                        seenItems[key] = true;
                ...
                setOcrPreviewItems((prev)=>{
                    ...
                    if (allDuplicates.length > 0) {
                        ...
                        if (newItems.length > 0) {
                            showNotification("success", "".concat(newItems.length, "개 항목 추가 (").concat(allDuplicates.length, "개 중복 제외)"));
                        } else {
                            showNotification("error", "모든 항목이 이미 추가되어 있습니다.");
                        }
                    } else if (newItems.length > 0) {
                        showNotification("success", "".concat(newItems.length, "개 항목이 자동 인식되었습니다!"));
                    }
                    return [
                        ...prev,
                        ...newItems
    ...
    const handleUseImage = ()=>{
        ...
        // 각 카테고리별로 항목 추가
        Object.entries(categoryTotals).forEach((param)=>{
            let [category, data] = param;
            addOrUpdateItem(category, data.amount, data.details);
        });
        // 결과 메시지
        const messages = Object.entries(categoryTotals).map((param)=>{
            let [cat, data] = param;
            return "".concat(cat, " ").concat(data.amount.toLocaleString("ko-KR"), "원");
        });
        showNotification("success", "".concat(messages.join(", "), " 추가됨"));
        handleOcrModalClose();
    };
            ...
            showCameraModal && typeof document !== 'undefined' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: capturedImages.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    isOcrProcessing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        ocrPreviewItems.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mb-6",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                children: ocrPreviewItems.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(item.category === "대중교통" && "bg-blue-50", item.category === "보험료" && "bg-purple-50", item.category === "의료비" && "bg-green-50", item.category === "전통시장" && "bg-orange-50", item.category === "문화체육" && "bg-pink-50"),
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "p-2 border-b",
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("text-xs px-2 py-1 rounded", item.category === "신용카드" && "bg-green-100 text-green-600", item.category === "체크카드" && "bg-cyan-100 text-cyan-600", item.category === "현금영수증" && "bg-yellow-100 text-yellow-600", item.category === "대중교통" && "bg-blue-100 text-blue-600", item.category === "보험료" && "bg-purple-100 text-purple-600", item.category === "의료비" && "bg-teal-100 text-teal-600", item.category === "전통시장" && "bg-orange-100 text-orange-600", item.category === "문화체육" && "bg-pink-100 text-pink-600"),
                                ...
                                ocrDuplicateItems.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        [
                                            ...new Map(ocrDuplicateItems.map((item)=>[
                                                    "".concat(item.merchant, "-").concat(item.amount),
                                                    item
                                                ])).values()
                                        ].map((item, idx)=>{
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: [
                                        "적용하기 ",
                                        ocrPreviewItems.length > 0 && "(".concat(ocrPreviewItems.length, "건)")
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/app/admin/page.tsx",
                                    lineNumber: 1687,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    disabled: isDisabled,
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("flex-1 py-3 font-bold border-2 border-black transition-all", cardType === type ? "bg-neo-cyan shadow-none translate-x-[2px] translate-y-[2px]" : isDisabled ? "bg-gray-200 text-gray-400 cursor-not-allowed opacity-50" : clickedBtn === btnId ? "bg-neo-orange translate-x-[2px] translate-y-[2px] shadow-none" : "bg-white shadow-[4px_4px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000]"),
                                    children: label
                                }, type, false, {
                                    fileName: "[project]/app/admin/page.tsx",
                                    lineNumber: 2342,
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: item.category === "excluded" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    lineNumber: 2455,
                                                                    columnNumber: 61
                                                                }, this) : item.category === "market" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    lineNumber: 2457,
                                                                    columnNumber: 61
                                                                }, this) : item.category === "culture" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(AdminPage, "2CSQ1RoGz3TKDEviutds9u2L8YM=");
_c = AdminPage;
var _c;
