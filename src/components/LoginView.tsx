...
export const LoginView = ({ onLogin, onSignup }: LoginViewProps) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] animate-fade-in px-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight">로그인</h1>
                ...
                <div className="neo-card bg-white">
                    ...
                    <div className="text-center p-4 border-[3px] border-dashed border-gray-300">
                        <p className="font-bold text-gray-600 mb-2">아직 계정이 없으신가요?</p>
                        <button
                            onClick={onSignup}
