...
export const SignupView = ({ onSignup, onLogin }: SignupViewProps) => {
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] animate-fade-in px-4 py-12">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight">회원가입</h1>
                ...
                <div className="neo-card bg-white">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                        <div>
                            <label className="block font-black text-sm mb-2 uppercase tracking-wide">이름</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                        ...
                        <div>
                            <label className="block font-black text-sm mb-2 uppercase tracking-wide">이메일</label>
                            <input
                                type="email"
                                name="email"
                        ...
                        <div>
                            <label className="block font-black text-sm mb-2 uppercase tracking-wide">비밀번호</label>
                            <input
                                type="password"
                                name="password"
                        ...
                        <div>
                            <label className="block font-black text-sm mb-2 uppercase tracking-wide">비밀번호 확인</label>
                            <input
                                type="password"
                        ...
                        <label className="flex items-start gap-3 p-4 border-[3px] border-black mb-6 cursor-pointer group hover:bg-gray-50 transition-colors">
                            <div className="w-6 h-6 mt-0.5 border-[3px] border-black bg-white flex-shrink-0 flex items-center justify-center group-hover:bg-neo-yellow transition-colors">
                                <CheckCircle2 size={18} strokeWidth={3} className="opacity-0 group-hover:opacity-100" />
                            </div>
                            <span className="text-sm font-bold leading-relaxed">
                                <span className="text-neo-orange underline decoration-[2px]">이용약관</span> 및 <span className="text-neo-orange underline decoration-[2px]">개인정보처리방침</span>에 동의합니다
                            </span>
                        </label>
                    ...
                    <div className="text-center p-4 border-[3px] border-dashed border-gray-300">
                        <p className="font-bold text-gray-600 mb-2">이미 계정이 있으신가요?</p>
                        <button
                            onClick={onLogin}
